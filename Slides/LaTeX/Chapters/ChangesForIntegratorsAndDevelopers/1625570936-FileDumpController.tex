...
\begin{frame}[fragile]
	...
	\begin{itemize}
		\item The \texttt{FileDumpController} accepts two new parameters:
			...
			\end{itemize}
		\item See the
			\href{https://docs.typo3.org/c/typo3/cms-core/11.3/en-us/Changelog/master/Feature-92518-DownloadAndFilenameOptionsAddedToFileDumpController.html}{changelog}
