...
\begin{frame}[fragile]
	...
	\small
		...
		improvements and is now compatible with PHP version 8.0. User experience (UX)
		is about how users interact with a system or web interface.
		...
		TYPO3 developers and contributors should be aware that this upcoming TYPO3
		release will mark the \textbf{Feature Freeze} for the v11 cycle. Now is the
		best time to submit your code contributions to the TYPO3 Core if you want
		to see them in TYPO3 v11 LTS.
	\normalsize
