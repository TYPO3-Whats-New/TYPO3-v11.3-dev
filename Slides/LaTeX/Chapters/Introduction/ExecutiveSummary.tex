...
\begin{frame}[fragile]
	...
	\small
		...
		The next release on the roadmap is TYPO3 v11.4. TYPO3 developers and
		contributors should be aware that this TYPO3 release (scheduled on
		7 September 2021) will mark the \textbf{Feature Freeze} for the v11 cycle.
		Now is the best time to submit your code contributions to the TYPO3 Core
		if you want to see them in TYPO3 v11 LTS.
	\normalsize
