...
\begin{frame}[fragile]
	...
	\small
	    ...
	    utilisateur (UX) concerne la manière dans l'utilisateur interragit avec le système
	    ou l'interface Web.
        ...
        septembre 2021) marquera le \textbf{gèle des fonctionnalités} pour le cycle v11.
