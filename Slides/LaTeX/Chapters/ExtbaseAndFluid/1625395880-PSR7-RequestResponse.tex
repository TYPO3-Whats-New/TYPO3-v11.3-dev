...
\begin{frame}[fragile]
	...
	\begin{itemize}
		\item To follow unified standards and state-of-the-art technologies for
			extension developers, Extbase should feature a clean
			\href{https://www.php-fig.org/psr/psr-7/}{PSR-7 Request/Response} handling
		\item Therefore, the class
			...
			\small\texttt{ServerRequestInterface}\normalsize
