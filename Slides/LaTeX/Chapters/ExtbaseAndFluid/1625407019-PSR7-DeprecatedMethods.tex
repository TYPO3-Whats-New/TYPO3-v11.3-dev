		...
		\item Methods marked as \textbf{deprecated}:
			\begin{itemize}
				...
				\item \texttt{setDispatched()} and \texttt{isDispatched()}\newline
					\smaller(see \href{https://docs.typo3.org/c/typo3/cms-core/11.3/en-us/Changelog/master/Deprecation-94394-ExtbaseRequestSetDispatchedAndIsDispatched.html}{changelog} for migration options)\small
			\end{itemize}
